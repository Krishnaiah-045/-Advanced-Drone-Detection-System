/*
  Working Very Good
  Need to send 'a' from serial terminal then it sends 
  
  Drone  ->  @DR$
  UAV    ->  @UA$
  None   ->  @NO$
  
  Initially It takes time.. I think its not take time. It works on teachable machine (but idea now(12/3/2022)). Open IP address in good browser not like our laptop...
   Not worked initially from laptop, after open in mobile then satrts working.. may be browser or taking more than 15 min time  
*/



const char* ssid     = "iotserver";   //your network SSID
const char* password = "iotserver123";   //your network password
...
#define emailSenderAccount    "ebreakersfacemaskandtemp@gmail.com"
//#define emailSenderPassword   "SENDER_ACCOUNT_PASSWORD"
#define emailSenderPassword   "qrzhqkarfbgltxmf"

#define smtpServer            "smtp.gmail.com"
#define smtpServerPort        465
//#define emailSubject          "PIR-ON_Intruder-Detected"
#define emailRecipient        "cbituav1@gmail.com"
...
if(Serial.available() > 0)
  {
    ...
    if(gchr1 == 'm')
      {
        emailSubject = "";
        emailSubject = "UAV_Drone_Detected";
  ...
  if(cntlmk == 10 || cntlmk == 20 || cntlmk == 30 || cntlmk == 40 || cntlmk == 55)
    {
        if(P1 == "drone")
          {
            //Serial.print("@DR$");
...
static esp_err_t cmd_handler(httpd_req_t *req){
    ...
    //Serial.println("cmd= "+cmd+" ,P1= "+P1+" ,P2= "+P2+" ,P3= "+P3+" ,P4= "+P4+" ,P5= "+P5+" ,P6= "+P6+" ,P7= "+P7+" ,P8= "+P8+" ,P9= "+P9);   //Change-Disable
...
<html>
    ...
    <body>
        <h1 style="color:red;"> Drone And UAV Detection For Security Applications Using Deep Learning </h1>
        <section class="main">
            <figure>
                ...
                <div id="sidebar">
                    ...
                    <nav id="menu">
                        ...
                        <div class="input-group" style="display:none;">
                          ...
                          <input type="text" id="modelPath" value=https://teachablemachine.withgoogle.com/models/W5Bl1S8YI/>  // edit your Teachable machine Model                                                                            
                        </div>
                        <div class="input-group" style="display:none;">
